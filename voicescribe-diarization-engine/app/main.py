"""FastAPI application - Diarization Engine Service."""
...
from app.api.routers import router as diarization_router
...
async def lifespan(_: FastAPI):
    try:
        ...
        # Modalità degradata: servizio avviato ma /diarize risponderà 503
        pass
    yield
